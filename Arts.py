...
try:
    ...
    import os,sys,time,datetime,re,random,hashltex
hreading,json,getpass,urllib,cookielib,requests
...
\033[1;93m AUTHOR  : ARST TEAM 

\033[1;92m WhatsApp : +8801

\033[1;91m-----------------------------------------------

\033[1;92m BOSS : ARST TEAM 
...
def main():
    ...
    print("\033[1;95m[2]\033[1;97mFOLLOW THE ARTS ")
...
def menu_select():
	...
	print ("[!] ALLAH  HAFIZ (BOSS) RAXEELO Total Cp/Ok : "+str(len(cps)) + "/"+str(len(oks)))
	print (47*"-")
